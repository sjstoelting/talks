...
See [PostgreSQL As Data Integration Tool](tree/master/postgresql-as-data-integration-tool-pgDay-Paris-2019)
...
It was about PostgreSQL Foreign Data Wrapper(FDW) as described in the  ANSI standard SQL/MED.
See [PostgreSQL As Data Integration Tool](tree/master/postgresql-as-data-integration-tool-pgday-amsterdam-20
### Data source used in this talk
I used the [Chinook Database](https://github.com/lerocha/chinook-database) as data base.
...
See [NoSQL The SQL Way](tree/master/NoSQL-The-SQL-Way.Meetup-Prague-2018)
...
See [NoSQL The SQL Way](tree/master/NoSQL-The-SQL-Way.pgconf-de-2018)
...
It was about PostgreSQL Foreign Data Wrapper(FDW) as described in the  ANSI standard SQL/MED.
See [one-database-to-rule-em-all.perconalive-dublin-2017](tree/master/one-database-to-rule-em-all.perconalive-dublin-2017)
...
It was about PostgreSQL Foreign Data Wrapper(FDW) as described in the  ANSI standard SQL/MED.
See [one-database-to-rule-em-all.buzzwords-berlin-2017](tree/master/one-database-to-rule-em-all.buzzwords-berlin-2017)
...
See [NoSQL The SQL Way](tree/master/NoSQL-The-SQL-Way)
...
It was about PostgreSQL Foreign Data Wrapper(FDW) as described in the  ANSI standard SQL/MED.
See [one-database-to-rule-em-all.froscon](tree/master/one-database-to-rule-em-all.pgconfeu-2016)
...
It was about PostgreSQL Foreign Data Wrapper(FDW) as described in the  ANSI standard SQL/MED.
See [one-database-to-rule-em-all.froscon](tree/master/one-database-to-rule-em-all.froscon)
...
The talk covert PostgreSQL JSON features and included new functions and operators introduced in 9.5 and 9.6.
See [no-sql-as-not-only-sql-froscon-2016](tree/master/no-sql-as-not-only-sql-froscon-2016)
...
See [the-postgresql-json-feature-tour](tree/master/the-postgresql-json-feature-tour)
...
The talk covert PostgreSQL JSON features and included new functions and operators introduced in 9.5.
See [json-by-example](tree/master/json-by-example)
...
See [no-sql-as-not-only-sql](tree/master/no-sql-as-not-only-sql)
...
It was about PostgreSQL Foreign Data Wrapper(FDW) as described in the  ANSI standard SQL/MED.
See [one-database-to-rule-em-all](tree/master/one-database-to-rule-em-all)
...
See [json-by-the-other-elephant](tree/master/json-by-the-other-elephant)
...
See [meet-the-other-elephant](tree/master/meet-the-other-elephant)
