...
See [PostgreSQL As Data Integration Tool](postgresql-as-data-integration-tool-pgDay-Paris-2019)
...
It was about PostgreSQL Foreign Data Wrapper(FDW) as described in the  ANSI standard SQL/MED.
See [PostgreSQL As Data Integration Tool](postgresql-as-data-integration-tool-pgday-amsterdam-2018)
### Data source used in this talk
I used the [Chinook Database](https://github.com/lerocha/chinook-database) as data base.
...
See [NoSQL The SQL Way](NoSQL-The-SQL-Way.Meetup-Prague-2018)
...
See [NoSQL The SQL Way](NoSQL-The-SQL-Way.pgconf-de-2018)
...
It was about PostgreSQL Foreign Data Wrapper(FDW) as described in the  ANSI standard SQL/MED.
See [one-database-to-rule-em-all.perconalive-dublin-2017](one-database-to-rule-em-all.perconalive-dublin-2017)
...
It was about PostgreSQL Foreign Data Wrapper(FDW) as described in the  ANSI standard SQL/MED.
See [one-database-to-rule-em-all.buzzwords-berlin-2017](one-database-to-rule-em-all.buzzwords-berlin-2017)
...
See [NoSQL The SQL Way](NoSQL-The-SQL-Way)
...
It was about PostgreSQL Foreign Data Wrapper(FDW) as described in the  ANSI standard SQL/MED.
See [one-database-to-rule-em-all.froscon](one-database-to-rule-em-all.pgconfeu-2016)
...
It was about PostgreSQL Foreign Data Wrapper(FDW) as described in the  ANSI standard SQL/MED.
See [one-database-to-rule-em-all.froscon](one-database-to-rule-em-all.froscon)
...
The talk covert PostgreSQL JSON features and included new functions and operators introduced in 9.5 and 9.6.
See [no-sql-as-not-only-sql-froscon-2016](no-sql-as-not-only-sql-froscon-2016)
...
See [the-postgresql-json-feature-tour](the-postgresql-json-feature-tour)
...
The talk covert PostgreSQL JSON features and included new functions and operators introduced in 9.5.
See [json-by-example](json-by-example)
...
See [no-sql-as-not-only-sql](no-sql-as-not-only-sql)
...
It was about PostgreSQL Foreign Data Wrapper(FDW) as described in the  ANSI standard SQL/MED.
See [one-database-to-rule-em-all](one-database-to-rule-em-all)
...
See [json-by-the-other-elephant](json-by-the-other-elephant)
...
See [meet-the-other-elephant](meet-the-other-elephant)
